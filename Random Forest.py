...
# Create and train the Random Forest model using correlation-based features
print("Training Random Forest model with correlation-based features...")
model_corr = RandomForestRegressor(n_estimators=100, max_depth=20, random_state=42)
model_corr.fit(X_train_selected_corr, y_train)

# Create and train the Random Forest model using ANOVA-based features
print("Training Random Forest model with ANOVA-based features...")
model_anova = RandomForestRegressor(n_estimators=100, max_depth=20, random_state=42)
...
print("\nResults for Correlation-based Feature Selection with Random Forest:")
...
print("\nResults for ANOVA-based Feature Selection with Random Forest:")

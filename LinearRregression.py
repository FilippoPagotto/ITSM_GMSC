...
# Create and train the linear regression model using correlation-based features
model_corr = LinearRegression()
model_corr.fit(X_train_selected_corr, y_train)

# Create and train the linear regression model using ANOVA-based features
model_anova = LinearRegression()
...
print("Results for Correlation-based Feature Selection:")
...
step = 200  # Set the step variable
